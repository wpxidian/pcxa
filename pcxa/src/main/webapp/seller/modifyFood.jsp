...
<html>
  ...
  <body>
    <div class="content">
       <form id="addFoodForm" action="modifyFood" method="post">
        <fieldset>
          <legend>修改特色美食</legend>
         ...
         <textarea name="brief_introduction" id="brief_introduction" rows="4" cols="25">${food.briefIntroduction}</textarea>
          <br /><label for="introduction">美食介绍</label><div id="introductionTip"></div>
          <textarea id="introduction" name="introduction" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${food.introduction}</textarea>
          ...
          <br /><label for="address">地址</label><div id="addressTip"></div>
                <textarea id="address" name="address" rows="2" cols="15" >${food.address}</textarea>
          <br />
          <br /><label for="phone">电话</label><div id="phoneTip"></div>
          <input id="phone" type="text" name="phone" value="${food.phone}"/>
          <br />
          <br /><label for="bus">公交信息</label><div id="busTip"></div>  
          <textarea id="bus" name="bus" rows="2" cols="15" >${food.bus}</textarea>  
          <br />
          <br /><label for="link">店铺链接</label><div ></div>
           <input name="link" id="link" type="text" value="${food.link}"/>
          <br />
          <input type="hidden" name="id" value="${food.foodId}"/>
          <input type="hidden" class="picture_link" name="picture_link" value="${food.pictureLink}"/>
