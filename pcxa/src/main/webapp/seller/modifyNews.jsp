...
<html>
  ...
  <body>
    <div class="content">
       <form id="addNewsForm" action="updateNews" method="post">
        <fieldset>
          <legend>添加新闻</legend>
          <br /><label id="title" for="title">新闻标题</label><div id="titleTip"></div>
          <input id="title" type="text" name="title" value="${news.title}"/>
          
          <br /><label for="time">新闻时间</label><div id="timeTip"></div>
          <input id="time" type="text" name="time" value="${news.time}"/>
          
          <br /><label for="introduction">新闻介绍</label><div id="introductionTip"></div>
          <textarea id="introduction" name="introduction" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;">${news.introduction}</textarea>
          
          <br /><label for="uploadify">新闻主图片</label><div class="uploadifyTip"></div><input id="uploadify" name="uploadify" type="file"/>
          
          <br /><input type="hidden" name="picture_link" class="picture_link" value="${news.pictureLink}">
