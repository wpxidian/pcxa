...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="container">
			<form id="SellerAddGoodsForm" action="goods_insert" method="post">
			<div class="usernameContent">
				<fieldset>
				<legend>创建商品信息</legend>
				...
				<input id="quantity_left" name="quantity_left" type="text" size="20"/><div class="validatorTipContainer"><div id="quantity_leftTip" ></div></div>
				<label for="price">价格：</label>
				<input id="price" name="price" type="text" size="20"/><div class="validatorTipContainer"><div id="priceTip" ></div></div>
				<label for="send_method">配送方式：</label>
				<s:select id="send_method" list="{'发送短信','快递运输'}" name="send_method">				
				</s:select>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$.formValidator.initConfig({formID:"SellerAddGoodsForm",theme:'Default',debug:false,onSuccess:function(){
			...
			<%		
				URLHelper.addUploadButton(out, "#uploadify", "商品主图片", "#SellerAddGoodsForm", "picture_link",false,URLHelper.PICTURE_TYPE);
